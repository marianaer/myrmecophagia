...
${TRINITY_PATH}/util/abundance_estimates_to_matrix.pl --est_method kallisto  --name_sample_by_base_dir  ${Trinity_fasta}_kallisto/abundance.tsv --gene_trans_map ${Trinity_fasta}.gene.trans.map --out_prefix ${Trinity_fasta}_kallisto
